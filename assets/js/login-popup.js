...
(function () {
  ...
  var CSS = [
    ...
    'max-height:94dvh;overflow-y:auto;position:relative;padding:36px 34px 30px;',
    ...
    '.bsr-login-close{position:absolute;top:16px;right:16px;width:36px;height:36px;border:1px solid rgba(30,77,51,.25);',
    'background:#fff;font-size:20px;line-height:1;color:#1e4d33;cursor:pointer;border-radius:50%;',
    'display:flex;align-items:center;justify-content:center;box-shadow:0 2px 8px rgba(0,0,0,.12);font-weight:700}',
    ...
    '@media(max-width:767px){.bsr-login-card{padding:28px 26px 24px}',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:12px;margin:0 0 32px;padding:0 40px;box-sizing:border-box;',
    'font-family:var(--font-head,"Bitter",Georgia,"Times New Roman",serif);font-weight:800;font-size:1.55rem;',
    'letter-spacing:.01em;line-height:1.1;color:#1e4d33;white-space:nowrap}',
    '.bsr-brand img{width:54px;height:54px;object-fit:contain;flex:none}',
    ...
    '.bsr-passkey{text-align:center;margin:28px 0 0}',
    ...
    '.bsr-express-label{font-size:.82rem;font-weight:700;color:#1e4d33;letter-spacing:.08em;text-transform:uppercase;text-align:center}',
    '.bsr-express-sub{font-size:.8rem;color:#8a8172;text-align:center;margin-top:-8px;line-height:1.5}',
    ...
    'padding:10px 2px;font-size:1.04rem;color:#2a241b;border-radius:0;box-sizing:border-box;font-family:inherit}',
    ...
    '.bsr-hint{font-size:.8rem;color:#8a8172;margin:8px 0 0;line-height:1.55}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.74rem;color:#8a8172;margin:26px 0 0;line-height:1.6}',
    ...
    '.bsr-loginbtn{width:100%;min-height:52px;background:#1e4d33;color:#fff;border:none;border-radius:4px;',
  ...
  var CAPTCHA_NOTE = '<p class="bsr-captcha-note">This site is protected by ' +
    '<span class="bsr-cf-word">Cloudflare</span>.<br>See our ' +
  ...
  function buildForm(container) {
    container.innerHTML =
      ...
      '<span class="bsr-express-sub">One tap with Google or Amazon \u2014 no password needed.</span>' +
      circlesHtml() + '</div>' +
      ...
      '<p class="bsr-hint">Start with your email \u2014 sign in, create an account, or continue as a guest.</p>' +
