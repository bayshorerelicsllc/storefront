...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-backline{max-width:400px;margin:0 auto 28px}',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:14px;margin:4px 0 14px;',
    ...
    '.bsr-brand img{width:58px;height:58px;object-fit:contain;flex:none}',
    ...
    '.bsr-passkey{text-align:center;margin:24px 0 0}',
    ...
    'padding:24px 20px 26px;margin:20px 0 0}',
    '.bsr-expressbox .bsr-tagline{margin:0 0 18px}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.74rem;color:#8a8172;margin:22px 0 0;line-height:1.6}',
    ...
    '.bsr-loginbtn{width:100%;min-height:56px;background:#1e4d33;color:#fff;border:none;border-radius:4px;',
