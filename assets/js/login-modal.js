...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-captcha-note{text-align:center;font-size:.78rem;color:#8a8172;margin:28px 0 0;line-height:1.6}',
    '.bsr-captcha-note a{color:#2a241b}',
    '.bsr-cf-mark{height:1.15em;width:auto;vertical-align:-0.22em;margin-right:.4em}',
  ...
  var CAPTCHA_NOTE = '<p class="bsr-captcha-note"><img class="bsr-cf-mark" src="/assets/img/cloudflare-cloud-mark.png" alt="Cloudflare">' +
    'This site is protected by Cloudflare and our <a href="/privacy/">Privacy Policy</a> and ' +
