...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-brand{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:14px;margin:6px 0 12px;',
    'font-family:var(--font-head,"Bitter",Georgia,"Times New Roman",serif);font-weight:800;font-size:2.2rem;',
    'letter-spacing:.01em;line-height:1.1;color:#1e4d33;text-align:center}',
    '.bsr-brand img{width:88px;height:88px;object-fit:contain;flex:none}',
    ...
    '.bsr-tagline{text-align:center;color:#8a8172;font-size:1rem;margin:0 0 46px;line-height:1.6}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.78rem;color:#8a8172;margin:0 0 26px;line-height:1.6}',
    ...
    '.bsr-circle{width:62px;height:62px;border-radius:50%;background:#fff;border:1px solid #d5d5d5;',
