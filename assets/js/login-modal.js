...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-backline{max-width:400px;margin:0 auto 10px}',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:10px;margin:0 0 6px;',
    ...
    '.bsr-brand img{width:44px;height:44px;object-fit:contain;flex:none}',
    ...
    '.bsr-passkey{text-align:center;margin:12px 0 0}',
    ...
    'padding:12px 20px;margin:10px 0 0}',
    '.bsr-expressbox .bsr-tagline{margin:0 0 10px;font-size:.92rem}',
    ...
    '.bsr-hint{font-size:.78rem;color:#8a8172;margin:6px 0 0;line-height:1.5}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.7rem;color:#8a8172;margin:10px 0 0;line-height:1.45}',
    ...
    '.bsr-or{display:flex;align-items:center;gap:12px;margin:14px 0 12px;color:#8a8172;',
