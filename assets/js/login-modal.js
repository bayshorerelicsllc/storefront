...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-login-close{position:absolute;top:14px;right:14px;width:36px;height:36px;border:1px solid rgba(30,77,51,.25);',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:12px;margin:0 0 12px;',
    ...
    '.bsr-passkey{text-align:center;margin:20px 0 0}',
    ...
    '.bsr-express{display:flex;align-items:center;justify-content:center;gap:16px;margin:12px 0 0}',
    '.bsr-express-label{font-size:.92rem;font-weight:700;color:#2a241b}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.74rem;color:#8a8172;margin:18px 0 0;line-height:1.6}',
    ...
    '.bsr-or{display:flex;align-items:center;gap:14px;margin:26px 0 22px;color:#8a8172;',
    'font-size:.8rem;letter-spacing:.12em;font-weight:600}',
    '.bsr-or::before,.bsr-or::after{content:"";flex:1;height:1px;background:#d8d0b8}',
    '.bsr-circles{display:flex;justify-content:center;gap:14px;margin:0}',
    '.bsr-circle{width:50px;height:50px;border-radius:50%;background:#fff;border:2px solid #1e4d33;',
    ...
    '.bsr-circle svg{width:22px;height:22px;display:block}',
