...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-login-close{position:absolute;top:10px;right:10px;width:32px;height:32px;border:1px solid rgba(30,77,51,.25);',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:12px;margin:0 auto 24px;max-width:calc(100% - 76px);padding-right:20px;box-sizing:border-box;',
