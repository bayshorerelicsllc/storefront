...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-backline{max-width:400px;margin:0 auto 18px;padding-top:2px}',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:10px;margin:0 0 8px;',
    'font-family:var(--font-head,"Bitter",Georgia,"Times New Roman",serif);font-weight:800;font-size:1.45rem;',
    ...
    '.bsr-passkey{text-align:center;margin:10px 0 0}',
    ...
    'background:#fff8e6;border:1px solid #e8d48b;border-radius:10px;padding:12px 14px}',
    ...
    'padding:16px 16px 18px;margin:14px 0 0}',
    '.bsr-expressbox .bsr-tagline{margin:0 0 12px;font-size:.95rem}',
    ...
    'padding:8px 2px;font-size:1.02rem;color:#2a241b;border-radius:0;box-sizing:border-box;font-family:inherit}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.74rem;color:#8a8172;margin:12px 0 0;line-height:1.5}',
    ...
    '.bsr-loginbtn{width:100%;min-height:50px;background:#1e4d33;color:#fff;border:none;border-radius:4px;',
    ...
    '.bsr-or{display:flex;align-items:center;gap:14px;margin:18px 0 14px;color:#8a8172;',
