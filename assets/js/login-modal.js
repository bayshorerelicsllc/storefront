...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-backline{max-width:400px;margin:0 auto 14px}',
    ...
    '.bsr-brand{display:flex;align-items:center;justify-content:center;gap:12px;margin:0 0 10px;',
    ...
    '.bsr-brand img{width:50px;height:50px;object-fit:contain;flex:none}',
    ...
    '.bsr-passkey{text-align:center;margin:16px 0 0}',
    ...
    '.bsr-expressbox .bsr-tagline{margin:0 0 12px;font-size:.98rem}',
    ...
    '.bsr-captcha-note{text-align:center;font-size:.72rem;color:#8a8172;margin:14px 0 0;line-height:1.5}',
    ...
    '.bsr-or{display:flex;align-items:center;gap:14px;margin:20px 0 16px;color:#8a8172;',
    ...
    '.bsr-circle{width:56px;height:56px;border-radius:50%;background:#fff;border:2px solid #1e4d33;',
