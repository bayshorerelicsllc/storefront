...
(function () {
  ...
  var CSS = [
    ...
    '.bsr-oauth-pills{display:flex;flex-direction:column;gap:10px;margin:0 0 6px}',
    '.bsr-oauth-pill{display:flex;align-items:center;justify-content:center;gap:10px;width:100%;',
    'padding:12px 16px;border:1px solid #ddd5bd;border-radius:999px;background:#fff;color:#2a241b;',
    'font-size:.95rem;font-weight:550;cursor:pointer;text-decoration:none;box-sizing:border-box;transition:box-shadow .15s}',
    '.bsr-oauth-pill:hover{box-shadow:0 2px 10px rgba(30,77,51,.14);border-color:#1e4d33}',
    ...
    '.bsr-btn{display:block;width:100%;border:none;border-radius:999px;padding:14px 16px;font-size:1rem;',
    'font-weight:600;cursor:pointer;background:#1e4d33;color:#fff;transition:filter .15s}',
    '.bsr-btn:hover{filter:brightness(1.08)}',
